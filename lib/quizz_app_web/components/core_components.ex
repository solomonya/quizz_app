defmodule QuizzAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(QuizzAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(QuizzAppWeb.Gettext, "errors", msg, opts)
    end
  end
